...
SWIFT_PROTOCOL("_TtP12AcuantCamera21BarcodeCameraDelegate_")
@protocol BarcodeCameraDelegate
- (void)capturedWithBarcode:(NSString * _Nullable)barcode;
@end


SWIFT_CLASS("_TtC12AcuantCamera27BarcodeCameraViewController")
@interface BarcodeCameraViewController : UIViewController
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
- (nonnull instancetype)initWithOptions:(CameraOptions * _Nonnull)options delegate:(id <BarcodeCameraDelegate> _Nonnull)delegate OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_PROTOCOL("_TtP12AcuantCamera22BarcodeCaptureDelegate_")
@protocol BarcodeCaptureDelegate
- (void)capturedWithBarcode:(NSString * _Nullable)barcode;
@end


@interface BarcodeCameraViewController (SWIFT_EXTENSION(AcuantCamera)) <BarcodeCaptureDelegate>
- (void)capturedWithBarcode:(NSString * _Nullable)barcode;
@end



SWIFT_CLASS("_TtC12AcuantCamera21BarcodeCaptureSession")
@interface BarcodeCaptureSession : AVCaptureSession
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface BarcodeCaptureSession (SWIFT_EXTENSION(AcuantCamera)) <AVCaptureMetadataOutputObjectsDelegate>
...
@interface DocumentCameraController (SWIFT_EXTENSION(AcuantCamera)) <FrameAnalysisDelegate>
- (void)onFrameAvailableWithFrameResult:(enum FrameResult)frameResult points:(NSArray<NSValue *> * _Nullable)points;
@end


@interface DocumentCameraController (SWIFT_EXTENSION(AcuantCamera)) <AutoCaptureDelegate>
- (BOOL)getAutoCapture SWIFT_WARN_UNUSED_RESULT;
- (void)setAutoCaptureWithAutoCapture:(BOOL)autoCapture;
@end
...
@interface DocumentCameraController (SWIFT_EXTENSION(AcuantCamera)) <DocumentCaptureDelegate>
- (void)readyToCapture;
- (void)documentCapturedWithImage:(UIImage * _Nonnull)image barcodeString:(NSString * _Nullable)barcodeString;
@end
...
@interface DocumentCaptureSession (SWIFT_EXTENSION(AcuantCamera)) <AVCaptureMetadataOutputObjectsDelegate>
- (void)captureOutput:(AVCaptureMetadataOutput * _Nonnull)output didOutputMetadataObjects:(NSArray<AVMetadataObject *> * _Nonnull)metadataObjects fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end


@interface DocumentCaptureSession (SWIFT_EXTENSION(AcuantCamera)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end
...
@interface DocumentCaptureSession (SWIFT_EXTENSION(AcuantCamera)) <AVCapturePhotoCaptureDelegate>
