...
let ReadyRemitSDKPackage = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AcuantCamera",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/AcuantCamera.xcframework.zip",
            checksum: "e4edd8bdbbcaa60108dc34cb7d4049221387738108d62b24f5104b0ce8e0001d"
        ),
        .binaryTarget(
            name: "AcuantCommon",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/AcuantCommon.xcframework.zip",
            checksum: "67d7caa56fb14b42bc2220371366564a14f69737b816b140217bd1f301869f4e"
        ),
        .binaryTarget(
            name: "AcuantFaceCapture",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/AcuantFaceCapture.xcframework.zip",
            checksum: "72f112c678f6bcdf2769d0dde8f29c8f630a91d8c50bdedeeacb5b600f0e641d"
        ),
        .binaryTarget(
            name: "AcuantImagePreparation",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/AcuantImagePreparation.xcframework.zip",
            checksum: "b90f5f12a26f244b73acdacfe6b55348826d17ebd0004452a37013aeb01ab8d9"
        ),
        .binaryTarget(
            name: "AcuantPassiveLiveness",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/AcuantPassiveLiveness.xcframework.zip",
            checksum: "aa18237e580c094132d6950aa0879cf87eeef8e88fcd0b6f0ef4c7bd0b4daafe"
        ),
        .binaryTarget(
            name: "ScanForensicsPlus",
            url: "https://github.com/lucasbordini/rrm/raw/main/Sources/ScanForensicsPlus.xcframework.zip",
